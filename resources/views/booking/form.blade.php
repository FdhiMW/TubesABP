                ...
                <form action="{{ route('booking.store') }}" method="POST" id="bookingForm">
                    ...
                    <div id="step1" class="form-step">
                        ...
                        <div style="margin-bottom:16px;">
                            ...
                            <input type="text" name="bride_groom_name" placeholder="Andi & Salabila" style="width:100%; padding:12px 16px; border:1px solid #ddd; border-radius:8px; font-size:14px; box-sizing:border-box;" required>
                        </div>

                        <div style="margin-bottom:16px;">
                            <label style="display:block; margin-bottom:8px; color:#0b3120; font-weight:600;">Email</label>
                            <input type="email" name="email" placeholder="andi.salsa@gmail.com" style="width:100%; padding:12px 16px; border:1px solid #ddd; border-radius:8px; font-size:14px; box-sizing:border-box;" required>
                        </div>

                        <div style="margin-bottom:24px;">
                            <label style="display:block; margin-bottom:8px; color:#0b3120; font-weight:600;">No Telepon / WhatsApp</label>
                            <input type="tel" name="phone" placeholder="+62 812-9876-5432" style="width:100%; padding:12px 16px; border:1px solid #ddd; border-radius:8px; font-size:14px; box-sizing:border-box;" required>
                        </div>
                    </div>
                    ...
                    <div id="step2" class="form-step" style="display:none;">
                        ...
                        <div style="margin-bottom:16px;">
                            ...
                            <input type="time" name="event_time" value="10:00 AM" style="width:100%; padding:12px 16px; border:1px solid #ddd; border-radius:8px; font-size:14px; box-sizing:border-box;" required>
                        </div>
                        ...
                        <div style="margin-bottom:16px;">
                            <label style="display:block; margin-bottom:8px; color:#0b3120; font-weight:600;">Pilih Venue</label>
                            <select name="venue" style="width:100%; padding:12px 16px; border:1px solid #ddd; border-radius:8px; font-size:14px; box-sizing:border-box;" required>
                        ...
                        <div style="margin-bottom:24px;">
                            <label style="display:block; margin-bottom:8px; color:#0b3120; font-weight:600;">Pilih Paket Awal</label>
                            <select name="package_initial" style="width:100%; padding:12px 16px; border:1px solid #ddd; border-radius:8px; font-size:14px; box-sizing:border-box;" required>
